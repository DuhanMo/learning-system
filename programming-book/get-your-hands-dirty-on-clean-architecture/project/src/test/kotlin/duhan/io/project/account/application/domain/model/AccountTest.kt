...
import duhan.io.project.account.fixtures.createAccount
import duhan.io.project.account.fixtures.createActivity
...
class AccountTest {
    ...
    fun withdrawalSucceeds() {
        ...
        // when
        val success = account.withdraw(money = Money.of(555L), targetAccountId = AccountId(28L))
